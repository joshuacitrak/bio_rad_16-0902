function startAd(){  
    ...
    ttl.from("#t1", .8, {scale:0, opacity:0, ease: Power3.easeOut})
        .to("#t1", .8, {opacity:0, x:-60, ease: Power3.easeOut}, 3)
        ...
        .to("#t2", .8, {opacity:0, y:-60, ease: Power3.easeOut}, 11)
        .to("#t5", .8, {x:-60, opacity:0, ease: Power3.easeOut}, 13)
        ...
        .to("#t6", .8, {opacity:0, y:-60, ease: Power3.easeOut}, 18.6)
    ...
    wtl.from("#dotwatch", .8, {scale:0, opacity:0, ease: Power3.easeOut})
        .to("#dotwatch", .8, {x:60, opacity:0, ease: Power3.easeOut}, 3)
         .to("#dotwatch", .8, {x:0, scale:0}, 10)
         .to("#dotwatch", .8, {opacity:1, scale:1, ease: Power3.easeOut}, 11)
        .to("#dotwatch", .8, {x:60,opacity:0, ease: Power3.easeOut}, 13);
